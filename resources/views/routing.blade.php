...
<body>
    <div class="container m-5">
        ...
        <div class="list-group mt-4">
            <a href="{{ route('bootstrapclone') }}" class="list-group-item list-group-item-action">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <h6 class="mt-4">View Route List</h6>
                <div class="list-group mt-4">
                    <a href="{{ route('route-list') }}" class="list-group-item list-group-item-action text-danger">
                        php artisan route:list
                    </a>
                </div>
            <h6 class="mt-4">Route Caching</h6>
                <div class="list-group mt-4">
                    <a href="{{ route('route-cache') }}" class="list-group-item list-group-item-action text-danger">
                        php artisan route:cache
                    </a>
                    <a href="{{ route('clear-route') }}" class="list-group-item list-group-item-action text-danger">
