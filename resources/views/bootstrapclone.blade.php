        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <p class="fs-5 mt-3">Quickly design and customize responsive mobile-first sites with Bootstrap, the world's most popular front-end open source
                        toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt compoents, and powerful JavaScript plugins.</p>
                    <div class="row">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Get Bootstrap Icons<i class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid" src="assets/image/bs-icons.png" alt="Bootstrap Icons">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the <a href="#">official Boostrap Themes marketplace</a>.
                    Themes are built on Bootstrap as their own extended frameworks, rich with new components and plugins, documentation, and powerful build tools.</p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">Browse Bootstrap Themes<i class="bi bi-arrow-right mb-2"></i></a>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid" src="assets/image/bs-themes.png" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
